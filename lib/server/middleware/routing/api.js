...
router.post('/user/search',                 requireAuthentication, bind('api/user/search'));
router.get('/user/permission/:workSpaceId', requireAuthentication, bind('api/user/permission'));
router.post('/user/password/:id',           requireAuthentication, bind('api/user/password'));
